	...
	return (
		<div>
			...
			<div className="flex gap-4">
				...
				<button onClick={share} className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white dark:hover:bg-gray-700 group w-full hover:text-white hover:bg-[#646cff] duration-75">
					...
					<span className="ms-3">Partager</span>
				</button>
