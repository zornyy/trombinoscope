...
export default function Subject({ subject }) {
    return (
        <div className="flex flex-col items-center pb-2">
            <img className="w-24 h-24 mb-3 rounded-full shadow-lg object-cover" src={subject.image?.length > 0 ? `${import.meta.env.VITE_BACKEND_URL}/api/files/Subject/${subject.id}/${subject.image}` : placeholder} />
